...
namespace RPA
{
    internal static class ClipboardMonitor
    {
        ...
        // in Recorder.cs:
        // StartRecording() {
        //     MyClipboardMonitor.OnClipboardChange += ClipboardMonitor_OnClipboardChange;
    ...
    class ClipboardWatcher : Form
        {
            ...
            public static void Stop()
            {
                if (mInstance != null && mInstance.IsHandleCreated)
                {
            ...
            private readonly string[] formats = Enum.GetNames(typeof(ClipboardFormat));
